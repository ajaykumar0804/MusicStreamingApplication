...
import StemSeparationDialog from "@/components/StemSeparationDialog";
				...
				<div className='hidden sm:flex items-center gap-4 min-w-[180px] w-[30%] justify-end'>
					...
					<div className="p-4">
						...
						<button
							...
							className="p-3 bg-black text-white rounded-full shadow-lg cursor-pointer"
						>
							<Mic2 className='h-6 w-6' />
						</button>

						{/* Open Stem Separation Dialog */}
						{isDialogOpen && <StemSeparationDialog onClose={() => setIsDialogOpen(false)} />}
					</div>
